...
class WidgetSeeder extends Seeder
{
    public function run()
    {
        ...
        $widgetGroups = [
            [
                'group_name' => 'homepage',
                'group_label' => 'Home Page Widget',
                'location' => 'left',
                'widgets' =>  [
                    [
                        'meta_name' => 'most_trending_products',
                        'meta_title' => 'Most Trending Products',
            ...
            [
                ...
                'widgets' =>  [
                    [
                        ...
                        'settings' => [
                            'Home' => route('home'),
                            'Store' => route('store.list'),
                            'Shop' => route('shop.list'),
                        ],
                    ],
                    [
                        'meta_name' => 'second_navbar',
                        'meta_title' => 'Second Navbar Menu',
                        'meta_value' => 'content',
                        'field_type' => 'text',
                        'sorting' => 2,
                        'settings' => [
