...
use \TomatoPHP\FilamentEcommerce\Filament\Resources\ProductResource as BaseResource;
...
class ProductResource extends BaseResource
{
    ...
    {
        $data = Product::where('type', 'product')->where('shop_id', static::currentShopId());
        return $data;
    }
                        ...
                        Forms\Components\Tabs\Tab::make(trans('filament-ecommerce::messages.product.tabs.details'))
                            ...
                            ->schema([
                                ...
                                Forms\Components\TextInput::make('sku')
                                    ...
                                    ->unique(\TomatoPHP\FilamentEcommerce\Models\Product::class, column: 'sku', ignoreRecord:true)
                                    ->maxLength(255),
