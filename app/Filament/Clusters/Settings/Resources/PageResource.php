...
use App\Filament\Clusters\Settings\Resources\PageResource\Pages;
use App\Filament\Clusters\Settings\Resources\PageResource\RelationManagers;
use App\Models\Page;
use App\Models\User;
use Filament\Forms;
        ...
        $table = $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('slug')
                    ->label(trans('filament-cms::messages.content.posts.sections.post.columns.slug'))
                    ->description(fn(Post $post) => Str::of('/page/'.$post->slug)->limit(50))
                    ->toggleable()
                    ->copyable()
                    ->searchable(),
