              ...
              <div class="row">
                  ...
                  <div class="col-6 text-end d-none d-md-block">
                      <div class="dropdown selectBox">
                          <a href="{{ route('filament.seller.auth.register') }}" class=" text-reset mx-3">Become a Seller
                          </a>
          ...
          <div class="container">
              <div class="offcanvas offcanvas-start" tabindex="-1" id="navbar-default"
                  ...
                  <div class="offcanvas-header pb-1">
                      <a href="index-2.html"><img src="{{ asset('frontend_asset/images/logo/freshcart-logo.svg"') }}"
                  ...
                  <div class="offcanvas-body">
                      ...
                      <div>
                          <ul class="navbar-nav align-items-center">
                              ...
                              <li class="nav-item w-100 w-lg-auto">
                                  <a class="nav-link" href="{{ route('store.list') }}">Store</a>
                              </li>
                              <li class="nav-item w-100 w-lg-auto">
                                      ...
                                      <div class="row p-2 p-lg-4">
                                          ...
                                          <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                              <div class="card border-0">
                                                  <img src="{{ asset('frontend_asset/images/banner/menu-banner.jpg') }}"
                              ...
                              <li class="nav-item dropdown w-100 w-lg-auto">
                                  ...
                                  <ul class="dropdown-menu">
                                      <li><a class="dropdown-item" href="{{ route('blog.list') }}">Blog</a></li>
                                      <li><a class="dropdown-item" href="{{ route('blog.single') }}">Blog Single</a>
                                      </li>
                                      <li><a class="dropdown-item" href="{{ route('blog.category') }}">Blog
                                              Category</a>
                                      </li>
                              ...
                              <li class="nav-item dropdown w-100 w-lg-auto">
                                  ...
                                  <ul class="dropdown-menu">
                                      <li><a class="dropdown-item" href="{{ route('account.signin') }}">Sign in</a>
                                      </li>
                                      <li><a class="dropdown-item" href="{{ route('account.signup') }}">Signup</a>
                                      </li>
                                      <li><a class="dropdown-item"
                                              href="{{ route('account.forgot.password') }}">Forgot
                                              Password</a></li>
                                          ...
                                          <ul class="dropdown-menu">
                                              <li>
                                                  <a class="dropdown-item"
                                                      href="{{ route('account.order') }}">Orders</a>
                                              </li>
                                              <li>
                                                  <a class="dropdown-item"
                                              ...
                                              <li><a class="dropdown-item"
                                                      href="{{ route('address.index') }}">Address</a></li>
                                              <li><a class="dropdown-item"
                                                      href="{{ route('account.payment.method') }}">Payment Method</a>
                                              </li>
                                              <li><a class="dropdown-item"
                                                      href="{{ route('account.notification') }}">Notification</a></li>
                                          </ul>
                                      </li>
                                  </ul>
                              </li>
