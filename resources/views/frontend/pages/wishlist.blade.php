                                ...
                                <table class="table text-nowrap table-with-checkbox">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="#"><img src="{{asset('frontend_asset')}}/images/products/product-img-18.jpg"
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="#"><img src="{{asset('frontend_asset')}}/images/products/product-img-17.jpg"
                                                        class="icon-shape icon-xxl" alt="" /></a>
                                            </td>
                                            <td class="align-middle">
                                                <div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="#"><img src="{{asset('frontend_asset')}}/images/products/product-img-16.jpg"
                                                        class="icon-shape icon-xxl" alt="" /></a>
                                            </td>
                                            <td class="align-middle">
                                                <div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="#"><img src="{{asset('frontend_asset')}}/images/products/product-img-19.jpg"
                                                        class="icon-shape icon-xxl" alt="" /></a>
                                            </td>
                                            <td class="align-middle">
                                                <div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="#"><img src="{{asset('frontend_asset')}}/images/products/product-img-15.jpg"
                                                        class="icon-shape icon-xxl" alt="" /></a>
                                            </td>
                                            <td class="align-middle">
                                                <div>
