                        ...
                        <div class="py-6 p-md-6 p-lg-10">
                            ...
                            <div class="d-flex justify-content-between mb-6 align-items-center">
                                ...
                                <a href="#" class="btn btn-outline-primary" data-bs-toggle="modal"
                                    data-bs-target="#paymentModal">Add Payment</a>
                            </div>
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item py-5 px-0">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex">
                                            <!-- img -->
                                            <img src="{{asset('frontend_asset')}}/images/svg-graphics/visa.svg" alt="" />
                                            <!-- text -->
                                            <div class="ms-4">
                                ...
                                <li class="list-group-item px-0 py-5">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex">
                                            <!-- img -->
                                            <img src="{{asset('frontend_asset')}}/images/svg-graphics/mastercard.svg" alt=""
                                                class="me-3" />
                                            <div>
                                ...
                                <li class="list-group-item px-0 py-5">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex">
                                            <!-- img -->
                                            <img src="{{asset('frontend_asset')}}/images/svg-graphics/discover.svg" alt=""
                                                class="me-3" />
                                            <div>
                                                <!-- text -->
                                ...
                                <li class="list-group-item px-0 py-5">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex">
                                            <!-- img -->
                                            <img src="{{asset('frontend_asset')}}/images/svg-graphics/americanexpress.svg" alt=""
                                                class="me-3" />
                                            <!-- text -->
                                            <div>
                                ...
                                <li class="list-group-item px-0 py-5 border-bottom">
                                    <div class="d-flex justify-content-between">
                                        <div class="d-flex">
                                            <!-- img -->
                                            <img src="{{asset('frontend_asset')}}/images/svg-graphics/paypal.svg" alt=""
                                                class="me-3" />
                                            <div>
                                                <!-- text -->
                        ...
                        <form class="row mb-4 needs-validation" novalidate>
                            <div class="mb-3 col-12 col-md-12 mb-4">
                                ...
                                <div class="d-inline-flex">
                                    <div class="form-check me-2">
                                        <input type="radio" class="form-check-input" id="paymentRadioOne"
                                            name="paymentRadioOne" required />
                                        <label class="form-check-label" for="paymentRadioOne"><img
                                                src="{{asset('frontend_asset')}}/images/payment/american-express.svg"
                                                alt="" /></label>
                                    </div>
                                    <!-- Radio button -->
                                    <div class="form-check me-2">
                                        ...
                                        <label class="form-check-label" for="paymentRadioTwo"><img
                                                src="{{asset('frontend_asset')}}/images/payment/mastercard.svg" alt="" /></label>
                                    </div>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="paymentRadioFour"><img
                                                src="{{asset('frontend_asset')}}/images/payment/visa.svg" alt="" /></label>
                                    </div>
                                </div>
                            </div>
                            <!-- Name on card -->
                            ...
                            <div class="mb-3 col-md-4 col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" name="cvv" id="digit-mask"
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <button class="btn btn-outline-gray-400 text-muted" type="submit"
