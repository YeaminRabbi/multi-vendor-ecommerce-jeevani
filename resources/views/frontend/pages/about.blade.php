                        ...
                        <div class="row align-items-center mb-14">
                            <div class="col-md-6">
                                ...
                                <div class="ms-xxl-14 me-xxl-15 mb-8 mb-md-0 text-center text-md-start">
                                    ...
                                    <p class="mb-0 lead">By powering the future of grocery with our retail partners, we give
                                        everyone access to the food they love and more time to enjoy it together.</p>
                                </div>
                            </div>
                            <!-- col -->
                            <div class="col-md-6">
                                <div>
                                    <!-- img -->
                                    <img src="{{ asset('frontend_asset') }}/images/about/about-img.jpg"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card bg-light mb-6 border-0">
                                    ...
                                    <div class="card-body p-8">
                                        <div class="mb-4">
                                            <!-- img -->
                                            <img src="{{ asset('frontend_asset') }}/images/about/about-icons-2.svg"
                                                alt="" />
                                        </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card bg-light mb-6 border-0">
                                    ...
                                    <div class="card-body p-8">
                                        <div class="mb-4">
                                            <!-- img -->
                                            <img src="{{ asset('frontend_asset') }}/images/about/about-icons-3.svg"
                                                alt="" />
                                        </div>
            ...
            <div class="team-slider mx-4">
                ...
                <div class="item">
                    <div class="bg-light rounded">
                        ...
                        <!-- img -->
                        <img src="{{ asset('frontend_asset') }}/images/about/team-1.png" alt=""
                            class="img-fluid" />
                    </div>
                </div>
                <!-- item -->
                <div class="item">
                    <div class="bg-light rounded">
                        ...
                        <!-- img -->
                        <img src="{{ asset('frontend_asset') }}/images/about/team-2.png" alt=""
                            class="img-fluid" />
                    </div>
                </div>
                <!-- item -->
                <div class="item">
                    <div class="bg-light rounded">
                        ...
                        <!-- img -->
                        <img src="{{ asset('frontend_asset') }}/images/about/team-3.png" alt=""
                            class="img-fluid" />
                    </div>
                </div>
                <!-- item -->
                <div class="item">
                    <div class="bg-light rounded">
                        ...
                        <!-- img -->
                        <img src="{{ asset('frontend_asset') }}/images/about/team-4.png" alt=""
                            class="img-fluid" />
                    </div>
                </div>
                <!-- item -->
                <div class="item">
                    <div class="bg-light rounded">
                        ...
                        <!-- img -->
                        <img src="{{ asset('frontend_asset') }}/images/about/team-5.png" alt=""
                            class="img-fluid" />
                    </div>
                </div>
                <!-- item -->
